...
# Parsing + Configuration Script – noderedPAG - Rev. A

This **Parsing + Configuration** script is designed for the **noderedPAG** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – noderedPAG Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **noderedPAG** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
